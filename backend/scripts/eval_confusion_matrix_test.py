...
ckpt_path = ROOT/'backend'/'models'/'leaf_classifier_test.pt'
assert ckpt_path.exists(), "leaf_classifier_test.pt not found. Train the classifier first."
...
plt.tight_layout()
out_path = ROOT/'frontend'/'confusion_matrix_test.png'
