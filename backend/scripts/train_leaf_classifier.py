...
assert data_dir.exists(), "pear-leaf-disease dataset not found in data/"
...
best_acc, best_path = 0.0, ROOT/'backend'/'models'/'leaf_classifier.pt'
...
print(f"Saved classifier to {best_path} with acc {best_acc:.3f}")
